...
var AppMain = function() {
	...
	haxe_Log.trace("electron",{ fileName : "AppMain.hx", lineNumber : 60, className : "AppMain", methodName : "new", customParams : ["electron " + process.versions["electron"]]});
	haxe_Log.trace("node",{ fileName : "AppMain.hx", lineNumber : 61, className : "AppMain", methodName : "new", customParams : ["node " + process.version]});
	haxe_Log.trace("system",{ fileName : "AppMain.hx", lineNumber : 62, className : "AppMain", methodName : "new", customParams : [process.platform + " " + process.arch]});
	this.init();
};
...
AppMain.prototype = {
	...
	,onKeyMappedHandler: function(value) {
		...
		case "link":
			...
			break;
		case "open":
			haxe_Log.trace(value,{ fileName : "AppMain.hx", lineNumber : 157, className : "AppMain", methodName : "onKeyMappedHandler"});
			break;
		case "orderedlist":
			this.insertBefore("1. ",3);
			break;
		case "save":
			haxe_Log.trace(value,{ fileName : "AppMain.hx", lineNumber : 156, className : "AppMain", methodName : "onKeyMappedHandler"});
			break;
		case "unorderedlist":
			this.insertBefore("* ",3);
			break;
		default:
			haxe_Log.trace("not sure what you want: " + value,{ fileName : "AppMain.hx", lineNumber : 183, className : "AppMain", methodName : "onKeyMappedHandler"});
		}
	}
	...
	,insertBefore: function(insertion,cursorOffset) {
		...
		if(doc.somethingSelected()) {
			...
			haxe_Log.trace(selections,{ fileName : "AppMain.hx", lineNumber : 230, className : "AppMain", methodName : "insertBefore"});
	...
	,onFolderOpenHandler: function() {
		...
		electron_renderer_IpcRenderer.send("OpenDialog",function() {
			haxe_Log.trace("OpenDialog",{ fileName : "AppMain.hx", lineNumber : 386, className : "AppMain", methodName : "onFolderOpenHandler"});
		});
	...
	,onSaveHandler: function() {
		...
		electron_renderer_IpcRenderer.send("SAVE_FILE",this.currentFile,this.get_inMarkdownValue(),function() {
			haxe_Log.trace("SAVE_FILE",{ fileName : "AppMain.hx", lineNumber : 398, className : "AppMain", methodName : "onSaveHandler"});
		});
	}
